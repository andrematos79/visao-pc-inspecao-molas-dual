...
APP_VERSION = "v19.0-final-v5"
APP_STAGE = "External Core Stable Engine"
...
# ==========================================================
CORE_V19_SCRIPT = BASE_DIR / "svc_core_molas_v19_final_v7.py"
    ...
    with st.container(border=True):
        ...
        if frame is None:
            ...
            try:
                ...
                frame_to_show = frame
            st.image(cv2.cvtColor(frame_to_show, cv2.COLOR_BGR2RGB), width=720)
